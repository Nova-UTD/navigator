...
subsystem_parser = subparsers.add_parser("subsystem", help="fetches the subsystem map")
...
launch_create_subparser = launch_subparser.add_parser(
    "create", help="create a new launch file"
)
launch_create_subparser.add_argument("path", help="path of launch file to create")
launch_create_subparser.add_argument(
    "metadata", help=f"JSON of metadata: {Metadata.help()}"
)
launch_create_subparser.add_argument(
    "nodes", help=f"JSON node list: [{LaunchFileNode.help()}]"
)
