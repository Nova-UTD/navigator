...
class SubsystemMap:
    ...
    def _add_executables(self, subsystem: str, pkg: str, executables: list[str]) -> None:
...
def get_ros2_pkg_map() -> PkgMap:
    ...
    #  pkg2: [exec1]
    #  pkg3: [exec1]
    pkg_executables = subprocess.check_output(["ros2", "pkg", "executables"]).decode("utf-8").splitlines()
