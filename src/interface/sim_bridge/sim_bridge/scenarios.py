...
def parked_in_intersection(sim_bridge, num_ped=0, num_cars=0):
    CLIENT_WORLD = 'Town07'
    EGO_SPAWN_X = -180
    EGO_SPAWN_Y = -163
    EGO_SPAWN_Z = 20.0
...
def normal(sim_bridge, num_ped=0, num_cars=0):
    CLIENT_WORLD = 'Town07'
    EGO_SPAWN_X = -180
    EGO_SPAWN_Y = -163
    EGO_SPAWN_Z = 20.0
    ...
    sim_bridge.world = sim_bridge.client.load_world(CLIENT_WORLD)
    setup_ego(sim_bridge, EGO_SPAWN_X, EGO_SPAWN_Y, EGO_SPAWN_Z, EGO_SPAWN_YAW)
    add_vehicles(sim_bridge, [None] * num_cars)
    add_pedestrians(sim_bridge, [None] * num_ped)
