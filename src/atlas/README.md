**Atlas** is Nova's state estimation system. State estimation is the calculation of the vehcile's
...
Atlas's core is a single Unscented Kalman Filter (UKF) provided by the open-source
...
Atlas also includes packages to support our UKF. The **ICP nudger** uses map data and real-time
