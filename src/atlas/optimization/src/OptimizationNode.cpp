...
OptimizationNode::OptimizationNode() : Node("optimization_node")
{
	...
	// Init timers
	map_pub_timer = this->create_wall_timer(5s, std::bind(&OptimizationNode::publishMarkerArray, this));
	check_surrounding_road_timer = this->create_wall_timer(1s, std::bind(&OptimizationNode::publishNearbyLanePolygons, this));
...
void OptimizationNode::generateMapMarkers()
{
...
void OptimizationNode::publishNearbyLanePolygons()
{
...
void OptimizationNode::publishMarkerArray()
{
...
void OptimizationNode::publishNearbyLaneMarkers(std::vector<std::shared_ptr<odr::Lane>> laneset)
{
