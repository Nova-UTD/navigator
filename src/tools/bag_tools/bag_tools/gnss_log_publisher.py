...
gps_log_path = "/mnt/sda1/bags/april16/putty20220416170158.log"
...
class GnssLogPublisher(Node):
    ...
    def __init__(self):
        ...
        self.gnss_pub = self.create_publisher(Odometry, '/sensors/gnss/odom', 10)
    ...
    def publish_next_gnss(self):
        ...
        msg.child_frame_id = "odom" # Should this be base_link? Doesn't make a huge difference.
