...
namespace navigator
{
    namespace MotionPlanner
    {
        ...
        public:
            ...
            double assign_velocity(SegmentedPath& assignee, const CarPose& my_pose, const std::vector<double>& bp_speed_limit, const std::vector<Collision>& collisions) const;
            //
            double cost_path(const SegmentedPath &path, const voltron_msgs::msg::FinalPath::SharedPtr ideal_path, const CarPose pose, size_t start, size_t end) const;
        ...
        private:
            ...
            std::pair<size_t,size_t> get_path_bounds(const voltron_msgs::msg::FinalPath::SharedPtr ideal_path, const CarPose pose) const;
            void put_speed(SegmentedPath& assignee, const std::vector<double>& speed) const;
            void smooth(std::vector<double>& speed_limit, double curr_speed) const;
        };
    }
}
